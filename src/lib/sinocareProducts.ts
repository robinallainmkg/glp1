...
export const SINOCARE_PRODUCTS: SinocareProduct[] = [
  {
    ...
    category: 'glucometer',
    imageUrl: 'https://en.sinocare.com/cdn/shop/files/1_4447d50b-10ba-4130-9eb7-2989901376de.jpg?v=1748482956&width=600',
    priceFromEur: 22.99,
    rating: 4.8,
  ...
  },
  {
    ...
    imageUrl: 'https://en.sinocare.com/cdn/shop/files/2000-2000_1.jpg?v=1777363133&width=600',
    priceFromEur: 24.99,
    rating: 4.7,
  ...
  },
  {
    ...
    category: 'cgm',
    imageUrl: 'https://en.sinocare.com/cdn/shop/files/3_1_42b5866d-fa6d-4391-b16d-9f1a9bdd5ffc.jpg?v=1733293108&width=600',
    priceFromEur: 49.90,
    rating: 4.6,
  ...
  },
  {
    ...
    category: 'glucometer',
    imageUrl: 'https://en.sinocare.com/cdn/shop/files/AQ_pro_glucometer_kit.jpg?v=1745819870&width=600',
    priceFromEur: 19.99,
    rating: 4.9,
  ...
  },
  {
    ...
    category: 'strips',
    imageUrl: 'https://en.sinocare.com/cdn/shop/files/aq50voicesmart_e1267303-8ab4-4cf0-9da2-aab08d23ebc2.jpg?v=1635151799&width=600',
    priceFromEur: 16.99,
    rating: 4.8,
  ...
  },
  {
    ...
    category: 'strips',
    imageUrl: 'https://en.sinocare.com/cdn/shop/files/smart100.jpg?v=1697706922&width=600',
    priceFromEur: 27.99,
    rating: 5.0,
  ...
  },
  {
    ...
    category: 'strips',
    imageUrl: 'https://en.sinocare.com/cdn/shop/files/aq_200.jpg?v=1770283149&width=600',
    priceFromEur: 49.99,
    rating: 5.0,
  ...
  },
  {
    ...
    category: 'bp_monitor',
    imageUrl: 'https://en.sinocare.com/cdn/shop/files/1_4.jpg?v=1728539983&width=600',
    priceFromEur: 34.99,
    rating: 4.9,
  ...
  },
  {
    ...
    imageUrl: 'https://en.sinocare.com/cdn/shop/files/9_1_e09a5ab4-a4aa-41b4-9056-9165bf5bb484.jpg?v=1760945908&width=600',
    priceFromEur: 14.99,
    rating: 5.0,
