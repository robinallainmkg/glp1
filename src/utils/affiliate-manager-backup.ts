...
const STATIC_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    name: "Glutamine",
    brand: "Nutrimuscle",
    description: "L-Glutamine pure en poudre pour la récupération musculaire et le soutien immunitaire. Essentielle pendant une perte de poids avec GLP-1 pour préserver la masse musculaire.",
    benefits: [
      "Améliore la récupération musculaire",
      "Soutient le système immunitaire",
      "Préserve la masse musculaire pendant la perte de poids",
      ...
      "Idéale en complément des GLP-1"
    ],
    price: "34,90 €",
    originalPrice: "36,74 €",
    discount: "5%",
    discountCode: "NMA_GLP1",
    image: "/images/products/glutamine.webp",
    affiliateUrl: "https://www.nutrimuscle.com/NMA_GLP1?redirect=/products/glutamine-l-glutamine-en-poudre",
    tags: ["glutamine", "récupération", "immunitaire", "post-glp1", "masse-musculaire"],
    rating: 4.7,
    reviews: 634,
    categories: ["nutrition", "récupération", "complément-alimentaire"],
    targetCollections: [
    ...
    commissionRate: "14%",
    placements: {
      "smart-content": { enabled: true, priority: 4 },
      "content-end": { enabled: true, priority: 3 },
      "banner": { enabled: true, priority: 4 },
