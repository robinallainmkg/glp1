---
title: "Jeûne et randonnée : comparatif des organisateurs labellisés FFJR (prix 2026)"
description: "Comment choisir un séjour jeûne et randonnée labellisé FFJR : ce que garantit vraiment le label, les prix réels constatés de 640 à 890 € la semaine, le déroulé jour par jour et les profils exclus."
pubDate: 2026-08-07
author: "Rédaction GLP-1 France"
category: "Retraites et séjours"
tags: ["jeûne et randonnée", "FFJR", "retraite", "perte de poids", "prix", "détox"]
collection: "retraites-bien-etre"
thumbnail: "/images/thumbnails/jeune-randonnee-organisateurs-ffjr-comparatif-prix.svg"
thumbnailAlt: "Comparatif des organisateurs de séjours jeûne et randonnée labellisés FFJR"
featured: false
published: true
schema: "Article"
faqSchema:
  - question: "Combien coûte un séjour jeûne et randonnée labellisé FFJR en 2026 ?"
    answer: "Les tarifs affichés par les centres labellisés pour une semaine hébergement inclus vont d'environ 640 € à 890 €. Exemples relevés sur les fiches organisateurs de la FFJR : Graziella jeûne et randonnée en Ardèche à partir de 640 €, le Château de Liviers à partir de 670 €, Jeûne Détox & Randonnée en Haute-Vienne à partir de 720 € pour 6 nuits, O fil de l'eau à partir de 890 €. Des suppléments existent selon les formules (par exemple +80 € pour une version sportive, +100 € pour une version jeûne et yoga chez Jeux Jeûne Rando)."
  - question: "Que garantit exactement le label FFJR ?"
    answer: "La FFJR est née en 2003, quand les sept premiers accompagnateurs formés par le couple Bölling se sont regroupés. Elle fédère aujourd'hui environ 130 centres et plus de 130 professionnels formés. Le label garantit que le séjour est encadré par un accompagnateur de jeûne agréé par la fédération, qu'il suit le protocole de type Buchinger sur 7 jours ou moins, et que l'organisateur recueille un consentement éclairé écrit. Ce n'est pas un agrément sanitaire : la FFJR n'est pas une autorité de santé et le séjour n'est pas un acte médical."
  - question: "Peut-on faire un jeûne et randonnée sous Wegovy, Mounjaro ou Ozempic ?"
    answer: "La charte FFJR réserve ses séjours à des personnes majeures « en bonne santé » qui ne nécessitent pas de prise en charge médicale. Un traitement GLP-1 prescrit pour une obésité est précisément une prise en charge médicale en cours : la plupart des organisateurs refusent ce profil, et certains excluent explicitement les « traitements médicaux lourds ». Il faut en parler à son médecin prescripteur et être transparent avec l'organisateur avant de réserver."
  - question: "Un certificat médical est-il obligatoire pour un séjour de jeûne ?"
    answer: "La charte FFJR n'impose pas de certificat médical au sens réglementaire : elle demande à l'accompagnateur de recueillir un consentement éclairé écrit et de vérifier que l'état de santé de la personne permet le jeûne. La fédération invite à demander l'avis de son médecin avant tout séjour, certaines contre-indications devant être respectées. Beaucoup de centres organisent en plus un entretien préalable systématique avant d'accepter une inscription."
  - question: "Le jeûne et randonnée fait-il maigrir durablement ?"
    answer: "Ce n'est pas sa finalité affichée, et aucun organisateur sérieux ne promet une perte de poids durable. L'ANSES rappelle dans son évaluation des pratiques alimentaires d'amaigrissement que toute recherche de perte de poids sans indication médicale formelle comporte des risques et qu'une demande d'amaigrissement relève d'un accompagnement médical. La perte constatée sur une semaine de jeûne est en grande partie hydrique et se reprend rapidement à la reprise alimentaire."
mainKeyword: "jeûne et randonnée organisateurs FFJR"
secondaryKeywords: ["jeûne et randonnée prix", "séjour jeûne randonnée France", "label FFJR", "stage jeûne et randonnée avis", "jeûne randonnée Ardèche"]
---
...
La Fédération francophone de jeûne et randonnée s'est créée **en 2003**, lorsque les sept premiers accompagnateurs formés par le couple Bölling se sont regroupés ([FFJR — Qui sommes-nous](https://www.ffjr.com/la-federation/qui-sommes-nous/)). Elle fédère aujourd'hui **environ 130 centres labellisés** et **plus de 130 professionnels** qu'elle forme et dont elle se porte garante.
...
| Organisateur | Lieu | Prix d'appel (semaine, hébergement inclus) |
|---|---|---|
| Graziella, jeûne et randonnée | Monts d'Ardèche (07) | à partir de **640 €** |
| Graziella — Château de Liviers | Ardèche (07) | à partir de **670 €** |
| Jeûne, Détox & Randonnée | Boisseuil (87), près de Limoges | à partir de **720 €** (6 nuits) |
| O fil de l'eau — Jeûne et Randonnée | Ardèche (07) | à partir de **890 €** |

Sources : fiches organisateurs FFJR ([Ardèche](https://www.ffjr.com/departement/07-ardeche/), [O fil de l'eau](https://www.ffjr.com/centre/o-fil-de-l-eau/)) et sites des centres ([jeune-detox-et-randonnee.fr](https://jeune-detox-et-randonnee.fr/)).

**L'écart de 250 € entre le premier et le dernier prix ne mesure pas la qualité de l'accompagnement** — l'accompagnateur est agréé dans les deux cas. Il mesure surtout le standing de l'hébergement et la taille du groupe. La FFJR classe d'ailleurs ses centres de 1 à 5 étoiles et permet de filtrer par taille de groupe : moins de 10 personnes, 10 à 15, ou plus de 15 ([Les séjours en pratique](https://www.ffjr.com/les-sejours-en-pratique/les-sejours/)).

Attention aussi aux suppléments, rarement visibles dans le prix d'appel. Chez Jeux Jeûne Rando, par exemple, la formule « sportif » est facturée **+80 €** et la formule « jeûne et yoga » **+100 €** par rapport au tarif de base, le prix le plus bas correspondant à une chambre à quatre ([grille tarifaire de l'organisateur](https://www.jeux-jeune-rando.com/des-tarifs-abordables-pour-nos-sejours-jeune-et-randonnee/)). Le supplément chambre individuelle est la variable qui fait le plus bouger la facture finale.
...
L'ANSES, dans son évaluation des risques liés aux pratiques alimentaires d'amaigrissement, rappelle que la recherche d'une perte de poids sans indication médicale formelle comporte des risques et qu'une demande d'amaigrissement relève d'un accompagnement médical ([rapport ANSES](https://www.anses.fr/fr/system/files/NUT2009sa0099Ra.pdf)). La perte affichée sur la balance après une semaine de jeûne est majoritairement hydrique et glycogénique : elle se reprend en quelques jours à la reprise alimentaire.

Ce que ces séjours apportent réellement, d'après ce qu'en disent les organisateurs eux-mêmes, tient plutôt à la rupture des automatismes alimentaires, à la remise en mouvement et au cadre collectif. C'est estimable — mais ce n'est pas un protocole de perte de poids. Si c'est votre objectif, comparez plutôt les options dans notre panorama des [retraites perte de poids en France](/collections/retraites-bien-etre/meilleures-retraites-perte-de-poids-france-prix/), ou vérifiez d'abord si vous relevez d'une prise en charge remboursée avec notre [test d'éligibilité au remboursement](/outils/test-eligibilite/).
