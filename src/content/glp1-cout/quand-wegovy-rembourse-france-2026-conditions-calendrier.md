...
thumbnailAlt: "Remboursement Wegovy France 2026 calendrier conditions"
collection: "glp1-cout"
affiliateCollection: "glp1-cout"
mainKeyword: "quand wegovy remboursé France 2026 conditions calendrier"
secondaryKeywords: ["wegovy remboursement date france", "wegovy remboursé sécurité sociale", "conditions remboursement wegovy 2026", "wegovy prise en charge mutuelle", "HAS CEPS wegovy calendrier"]
schema: "Article"
...
1. [Où en est le remboursement de Wegovy ?](#etat-des-lieux)
2. [Le calendrier prévisible](#calendrier)
3. [Les conditions d'éligibilité attendues](#conditions)
4. [Combien coûte Wegovy aujourd'hui sans remboursement ?](#cout-actuel)
...
<div data-sinocare-callout style="margin:1.5rem 0;background:linear-gradient(135deg,#ecfdf5,#f0fdfa);border-left:4px solid #14b8a6;border-radius:8px;padding:1.1rem 1.2rem;">
  <p style="margin:0 0 .4rem 0;font-weight:700;color:#0f766e;font-size:.95rem;">💡 Coûts annexes : matériel d'autosurveillance</p>
  <p style="margin:0 0 .7rem 0;color:#134e4a;font-size:.92rem;line-height:1.55;">En attendant le remboursement, le matériel reste à votre charge. Les bandelettes Sinocare (lecteurs glycémie) offrent un rapport qualité/prix intéressant pour le suivi régulier.</p>
  <a href="https://www.awin1.com/cread.php?awinmid=114180&awinaffid=2879557&clickref=glp1france_callout_strips-100_quand-wegovy-rembourse-france-2026&ued=https%3A%2F%2Fen.sinocare.com%2Ffr%2Fproducts%2F100pcs-sinocare-blood-glucose-test-strips-with-free-lancets" rel="sponsored noopener" target="_blank" style="display:inline-block;font-size:.85rem;color:#0f766e;font-weight:600;text-decoration:underline;">Voir le produit (lien sponsorisé) &rarr;</a>
</div>
...
L'un des freins au remboursement était la capacité de Novo Nordisk à approvisionner le marché français. Les [tensions d'approvisionnement](/collections/effets-secondaires-glp1/mesusage-glp1-france-detournement-risques/) qui avaient touché Ozempic en 2023-2024 avaient refroidi les autorités.

Novo Nordisk a répondu à cette inquiétude en doublant la capacité de production de son usine de **Chartres** (Centre-Val de Loire), le principal site de production de GLP-1 en France. L'entreprise a investi plus de 2 milliards d'euros dans l'extension de cette usine, qui emploie désormais plus de 4 500 salariés. Les contingentements sur Wegovy injectable ont été progressivement levés depuis fin 2025.

## Le calendrier prévisible {#calendrier}
...
- Réévaluation du traitement à **6 mois** et **12 mois**
- Arrêt si la perte de poids est inférieure à **5 %** du poids initial après 6 mois de traitement à dose optimale

### Ce que cela signifie concrètement

Ces conditions sont plus restrictives que les conditions d'accès actuel (prescription libre sur ordonnance, sans condition d'IMC, mais sans remboursement). Elles ciblent les patients pour lesquels le bénéfice médical est le plus important et le mieux documenté.
...
Certaines [mutuelles](/collections/glp1-cout/wegovy-remboursement-mutuelle/) commencent à proposer des forfaits de prise en charge partielle pour les traitements de l'obésité, y compris Wegovy. Ces forfaits varient de 50 à 200 euros par an selon les contrats. Renseignez-vous auprès de votre complémentaire santé.
...
Non. Le [remboursement des GLP-1](/collections/glp1-cout/remboursement-glp1-2026/) ne s'applique qu'à partir de la date d'inscription sur la liste des médicaments remboursables. Les achats antérieurs ne seront pas pris en charge.

---

*Cet article est régulièrement mis à jour en fonction de l'évolution du dossier de remboursement. Dernière mise à jour : mars 2026. Consultez votre médecin pour un avis personnalisé.*
