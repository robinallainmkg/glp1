---
title: "Carences sous GLP-1 : Vitamines et Fer | ANSM"
description: "Carences sous GLP-1 : déficits en fer, vitamines B1, B12, D et protéines. Bilans recommandés, seuils d'alerte et prévention ANSM."
pubDate: 2026-05-28
date: "2026-05-28"
...
thumbnailAlt: "Carences nutritionnelles sous GLP-1 vitamines fer alerte ANSM"
featured: true
published: true
priority: 1
schema: "Article"
faqSchema:
  - question: "Quelles carences nutritionnelles sont les plus fréquentes sous GLP-1 ?"
    answer: "Les carences les plus fréquemment observées sous traitement GLP-1 sont les déficits en fer (risque d'anémie), vitamine B1 ou thiamine (risque neurologique), vitamine B12 (fatigue, troubles neurologiques), vitamine D (fragilité osseuse) et protéines (fonte musculaire). Ces carences résultent de la réduction importante des apports alimentaires liée à l'effet coupe-faim du traitement."
  - question: "L'ANSM a-t-elle émis une alerte sur les carences sous GLP-1 ?"
    answer: "Oui, l'ANSM a renforcé ses recommandations de pharmacovigilance concernant les risques nutritionnels liés aux traitements GLP-1. Elle insiste sur la nécessité d'un suivi biologique régulier et d'un accompagnement diététique pour les patients sous sémaglutide ou tirzépatide, en particulier lors des phases de titration rapide."
  - question: "Quels bilans sanguins faire sous traitement GLP-1 ?"
    answer: "Il est recommandé de réaliser un bilan sanguin complet avant le début du traitement, puis tous les 3 à 6 mois, comprenant : NFS (numération formule sanguine), ferritine et coefficient de saturation de la transferrine, vitamine B12, vitamine B1, vitamine D (25-OH), albumine et préalbumine, calcémie, et bilan rénal."
  - question: "Comment prévenir les carences nutritionnelles sous Ozempic ou Wegovy ?"
    answer: "La prévention repose sur trois piliers : maintenir un apport alimentaire suffisant malgré la réduction de l'appétit (minimum 1200 kcal/jour), privilégier les aliments à haute densité nutritionnelle (protéines, légumes, fruits), et supplémenter si les bilans sanguins révèlent des déficits. Un suivi diététique spécialisé est fortement recommandé."
  - question: "Faut-il prendre des compléments alimentaires systématiquement sous GLP-1 ?"
    answer: "La supplémentation systématique n'est pas recommandée. Elle doit être guidée par les résultats des bilans sanguins. En revanche, une supplémentation en vitamine D est souvent justifiée chez les patients obèses (déficit fréquent avant même le traitement), et un apport protéique suffisant doit être garanti pour limiter la fonte musculaire."
mainKeyword: "carences nutritionnelles GLP-1"
secondaryKeywords: ["GLP-1 carence vitamine", "ANSM alerte GLP-1 nutrition", "fer vitamine B12 GLP-1", "déficit nutritionnel ozempic", "supplémentation GLP-1 vitamines"]
...
Les traitements GLP-1 — [Ozempic](/collections/traitements-glp1/guide-complet-ozempic/), [Wegovy](/collections/traitements-glp1/guide-complet-wegovy/), [Mounjaro](/collections/traitements-glp1/guide-complet-mounjaro/) — sont remarquablement efficaces pour la perte de poids. Mais cette efficacité repose en partie sur une **réduction drastique de l'appétit**, qui peut entraîner des apports alimentaires très insuffisants. L'ANSM a renforcé ses recommandations de pharmacovigilance sur ce sujet : les carences en fer, en vitamines B1, B12, D et en protéines constituent un risque réel et sous-estimé chez les patients sous agonistes GLP-1. Ce guide détaille les carences à surveiller, les signaux d'alerte, les bilans recommandés et les stratégies de prévention.
...
> **À lire aussi** : [préserver la masse musculaire](/collections/regime-glp1/glp1-fonte-musculaire-preserver-muscles/)


## Les carences à surveiller sous GLP-1
...
> **À lire aussi** : [apport en protéines sous GLP-1](/collections/regime-glp1/glp1-proteines/)
...
Pour en savoir plus sur les effets indésirables spécifiques, consultez notre guide sur les [effets secondaires de Mounjaro](/collections/effets-secondaires-glp1/effets-secondaires-mounjaro/).
...
> **À lire aussi** : [micronutriments essentiels sous GLP-1](/collections/regime-glp1/glp1-micronutriments/)
