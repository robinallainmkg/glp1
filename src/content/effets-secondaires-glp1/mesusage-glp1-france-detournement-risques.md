---
title: "Mésusage GLP-1 France : risques du détournement Ozempic"
...
priority: 2
schema: "Article"
mainKeyword: "mésusage GLP-1 France détournement ozempic"
secondaryKeywords: ["détournement ozempic perte de poids", "mésusage sémaglutide France", "ANSM GLP-1 sécurité", "ozempic sans diabète risques", "GLP-1 hors AMM"]
...
**Depuis le 23 juin 2025** : Tout médecin peut prescrire les GLP-1 pour l'obésité (Wegovy, Mounjaro, Saxenda) (levée de la restriction aux spécialistes), mais un formulaire de prescription spécifique est désormais obligatoire pour les antidiabétiques GLP-1 utilisés hors de leur indication principale.
...
Pour comparer les différents traitements GLP-1 disponibles, consultez notre guide [Quel traitement GLP-1 choisir ?](/guides/quel-traitement-glp1-choisir/).
...
Ozempic est indiqué pour le diabète de type 2, pas pour la perte de poids seule. [Wegovy](/collections/traitements-glp1/guide-complet-wegovy/) (même molécule, dosage différent) est approuvé pour l'obésité. Se faire prescrire Ozempic uniquement pour maigrir sans diabète constitue un mésusage et prive les patients diabétiques de leur traitement.
...
Les risques sont multiples : produit contrefait, dosage incorrect, absence de suivi médical, effets secondaires non détectés, interactions médicamenteuses. Consultez notre article sur les [contrefaçons GLP-1](/collections/effets-secondaires-glp1/contrefacon-glp1-faux-ozempic-danger/) pour comprendre les dangers.
