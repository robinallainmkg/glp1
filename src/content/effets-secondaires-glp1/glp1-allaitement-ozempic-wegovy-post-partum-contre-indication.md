...
seoDescription: "GLP-1 et allaitement : Ozempic, Wegovy et Mounjaro sont contre-indiqués. Délais, risques pour le nourrisson et alternatives sûres pour perdre du poids post-partum."
...
thumbnailAlt: "Allaitement et traitements GLP-1 contre-indication post-partum"
collection: "effets-secondaires-glp1"
affiliateCollection: "effets-secondaires-glp1"
priority: 2
schema: "Article"
mainKeyword: "GLP-1 allaitement ozempic wegovy post-partum contre-indication"
secondaryKeywords: ["ozempic allaitement maternel", "wegovy post-partum perte poids", "mounjaro allaitement risque", "semaglutide lait maternel", "perte poids allaitement sécurité"]
...
Ce scénario est rare mais il arrive, notamment chez les femmes qui tombent enceintes de manière inattendue sous GLP-1 (les fameux [« bébés Ozempic »](/collections/effets-secondaires-glp1/glp1-grossesse-fertilite-bebes-ozempic/)). Si vous avez pris un GLP-1 en début de grossesse sans le savoir et que vous allaitez désormais, il n'y a généralement pas lieu de s'alarmer. Le médicament a été arrêté depuis la découverte de la grossesse (plusieurs mois avant l'accouchement) et a été entièrement éliminé de votre organisme. Votre lait maternel n'en contient plus.
