---
title: "GLP-1 Neuropathie Optique NOIAN : Vision et Risques"
...
mainKeyword: "GLP-1 neuropathie optique NOIAN"
secondaryKeywords: ["ozempic vision trouble", "wegovy neuropathie optique", "semaglutide yeux NOIAN", "glp1 risque ophtalmologique", "NOIAN traitement GLP-1"]
schema: "Article"
published: true
priority: 2
...
**La NOIAN est-elle réversible ?**
Malheureusement, la récupération visuelle est souvent partielle. Environ 30 à 40 % des patients récupèrent partiellement leur vision dans les semaines suivant l'épisode, mais une perte séquelle est fréquente. Il n'existe pas de traitement curatif validé pour la NOIAN.

**Faut-il prévenir son ophtalmologue qu'on prend un GLP-1 ?**
Oui, il est conseillé de mentionner votre traitement lors de chaque examen ophtalmologique. Cette information peut influencer la surveillance et la conduite à tenir en cas de modification visuelle.

**Le risque augmente-t-il avec la durée du traitement ?**
Les données actuelles ne permettent pas de répondre définitivement à cette question. Les cas rapportés ont survenu à différents stades du traitement. La vigilance doit donc être maintenue sur toute la durée de la prescription.

**L'arrêt du traitement GLP-1 après une NOIAN prévient-il une récidive ?**
Il n'existe pas de données permettant de conclure formellement. L'arrêt peut être envisagé, mais la décision doit être individualisée en tenant compte du bénéfice global du traitement pour le patient.
