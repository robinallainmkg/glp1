---
title: "GLP-1 et Stéatose Hépatique NASH/MASLD : Vers un Traitement en 2026"
description: "GLP-1 stéatose hépatique NASH MASLD : le sémaglutide montre des résultats prometteurs dans l'essai MAESTRO-NASH. Réduction de la fibrose hépatique, impact pour les patients français."
pubDate: 2026-05-28
date: "2026-05-28"
updatedAt: 2026-05-28
author: "Dr. Marie Dubois"
category: "Recherche GLP-1"
tags: ["glp1", "stéatose hépatique", "NASH", "MASLD", "MASH", "sémaglutide", "foie", "obésité", "recherche", "2026"]
collection: "recherche-glp1"
thumbnail: "/images/thumbnails/recherche-clinique-glp1-illus.jpg"
thumbnailAlt: "Recherche GLP-1 stéatose hépatique NASH MASLD traitement"
featured: true
published: true
priority: 1
schema: "Article"
faqSchema:
  - question: "Le sémaglutide est-il déjà approuvé pour traiter la NASH en France ?"
    answer: "Non. En France, le sémaglutide est approuvé pour le diabète de type 2 (Ozempic) et l'obésité (Wegovy). L'indication NASH/MASH est en cours d'évaluation par les agences réglementaires sur la base des résultats des essais MAESTRO-NASH et ESSENCE."
  - question: "Combien de Français sont touchés par la stéatose hépatique ?"
    answer: "On estime qu'environ 18 à 25 % de la population adulte française est concernée par la stéatose hépatique (MASLD), soit 8 à 12 millions de personnes. Parmi elles, 2 à 5 % présentent la forme inflammatoire (MASH/NASH) avec un risque d'évolution vers la cirrhose."
  - question: "Le GLP-1 peut-il inverser une fibrose hépatique déjà installée ?"
    answer: "Les essais cliniques ont montré une amélioration de la fibrose hépatique chez une proportion significative de patients traités. Toutefois, les résultats varient selon le stade de la fibrose. Les stades précoces semblent plus réversibles que les stades avancés. Un suivi hépatologique régulier reste indispensable."
  - question: "Faut-il être en surpoids pour bénéficier d'un GLP-1 contre la NASH ?"
    answer: "La majorité des patients atteints de MASH sont en surpoids ou obèses, mais la maladie peut aussi toucher des personnes de poids normal. Les essais cliniques ont principalement inclus des patients en excès pondéral. L'indication future pourrait être élargie à tous les patients MASH, indépendamment du poids."
  - question: "Existe-t-il d'autres médicaments contre la NASH en dehors des GLP-1 ?"
    answer: "Oui. Le resmetirom (Rezdiffra), un agoniste des récepteurs thyroïdiens bêta, a été approuvé par la FDA en 2024 pour la NASH avec fibrose. D'autres molécules sont en cours d'évaluation. Les GLP-1 se distinguent par leur double action sur le foie et sur le poids."
mainKeyword: "GLP-1 stéatose hépatique NASH"
secondaryKeywords: ["sémaglutide foie gras", "MASLD traitement GLP-1", "NASH GLP-1 2026", "stéatose hépatique médicament", "foie gras non alcoolique traitement"]
...
1. [Qu'est-ce que la MASLD et la MASH ?](#definition)
2. [L'ampleur du problème en France](#epidemiologie)
3. [Pourquoi les GLP-1 agissent sur le foie](#mecanismes)
4. [L'essai MAESTRO-NASH : résultats du sémaglutide](#maestro-nash)
5. [L'essai ESSENCE : confirmation à grande échelle](#essence)
6. [Les autres molécules en compétition](#autres-molecules)
7. [Vers une approbation réglementaire](#approbation)
8. [Ce que cela signifie pour les patients français](#patients-francais)
9. [FAQ](#faq)
...
Ce changement reflète une meilleure compréhension de la maladie : il ne s'agit pas simplement de l'absence d'alcool, mais d'une pathologie métabolique à part entière, étroitement liée au [syndrome métabolique](/collections/glp1-perte-de-poids/glp1-syndrome-metabolique-traitement-composantes/), à l'obésité et au diabète de type 2.
...
| Dose de sémaglutide | Résolution de la MASH | Placebo |
|---|---|---|
| 0,1 mg/jour | Environ 40 % | Environ 17 % |
| 0,2 mg/jour | Environ 49 % | Environ 17 % |
| 0,4 mg/jour | Environ 59 % | Environ 17 % |
...
L'essai ESSENCE (Effect of Semaglutide on NASH and Liver Fibrosis) est l'essai de phase 3 pivot évaluant le sémaglutide 2,4 mg hebdomadaire (la dose utilisée dans [Wegovy](/collections/traitements-glp1/guide-complet-wegovy/)) chez des patients atteints de MASH avec fibrose significative (stades F2-F3).
...
Le [tirzépatide (Mounjaro)](/collections/traitements-glp1/guide-complet-mounjaro/), double agoniste GIP/GLP-1, fait également l'objet d'essais dans la MASH (programme SYNERGY-NASH). Les résultats préliminaires sont encourageants, avec des bénéfices hépatiques comparables ou supérieurs à ceux du sémaglutide, possiblement liés à une perte de poids plus importante.

### Comparaison des approches

| Molécule | Mécanisme | Effet poids | Stade de développement |
|---|---|---|---|
| Sémaglutide (Novo Nordisk) | GLP-1 | Oui (-13 à -16 %) | Phase 3 (ESSENCE) — dossier déposé |
| Resmetirom (Madrigal) | Agoniste THR-bêta | Minime | Approuvé FDA (2024) |
| Survodutide (Boehringer) | GLP-1/glucagon | Oui (-15 à -19 %) | Phase 2b |
| Tirzépatide (Lilly) | GIP/GLP-1 | Oui (-18 à -22 %) | Phase 2 (SYNERGY-NASH) |
...
Non. En France, le [sémaglutide](/collections/traitements-glp1/guide-complet-ozempic/) est approuvé pour le diabète de type 2 (Ozempic) et l'obésité (Wegovy). L'indication spécifique MASH/NASH est en cours d'évaluation par les agences réglementaires (FDA et EMA) sur la base des essais MAESTRO-NASH et ESSENCE. Une décision est attendue courant 2026.
...
Oui. Le resmetirom (Rezdiffra), un agoniste des récepteurs thyroïdiens bêta, a été approuvé par la FDA en 2024 pour la MASH avec fibrose significative. Le survodutide (double agoniste GLP-1/glucagon) et le [tirzépatide](/collections/traitements-glp1/guide-complet-mounjaro/) sont également en cours d'essais avancés. Les GLP-1 se distinguent par leur double action sur le foie et sur le poids, et par les [bénéfices cardiovasculaires](/collections/recherche-glp1/glp1-benefices-cardiovasculaires-coeur/) associés, particulièrement pertinents dans cette population à haut risque vasculaire.