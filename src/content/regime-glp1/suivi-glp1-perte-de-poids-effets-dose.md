---
title: "Suivi GLP-1 : Comment Suivre sa Perte de Poids, ses Effets et ses Doses"
description: "Guide pratique pour suivre efficacement votre traitement GLP-1 : journal de bord, courbe de poids, bilans sanguins, ajustement des doses et gestion des effets secondaires."
pubDate: 2026-05-28
date: "2026-05-28"
...
thumbnailAlt: "Suivi traitement GLP-1 perte de poids effets et dose"
featured: true
published: true
priority: 2
schema: "Article"
faqSchema:
  - question: "À quelle fréquence dois-je me peser sous traitement GLP-1 ?"
    answer: "Il est recommandé de se peser une fois par semaine, le même jour et à la même heure (idéalement le matin à jeun), pour obtenir une courbe de poids fiable et éviter le stress des fluctuations quotidiennes."
  - question: "Quand faut-il s'inquiéter d'un plateau de poids sous GLP-1 ?"
    answer: "Un plateau de 4 à 6 semaines est courant et normal. Au-delà de 8 semaines sans perte de poids malgré une bonne observance alimentaire et physique, consultez votre médecin pour envisager un ajustement de dose ou de traitement."
  - question: "Quels bilans sanguins faire pendant un traitement GLP-1 ?"
    answer: "Tous les 3 mois : glycémie à jeun, HbA1c (si diabète), fonction rénale (créatinine, DFG), bilan hépatique (ALAT, ASAT), lipides (cholestérol, triglycérides). Tous les 6 mois : vitamines B12, D, fer et ferritine."
  - question: "Peut-on perdre trop de poids sous GLP-1 ?"
    answer: "Oui. Une perte supérieure à 1 kg par semaine de manière prolongée peut entraîner une fonte musculaire, des carences et une fatigue importante. Signalez immédiatement une perte rapide à votre médecin."
  - question: "Combien de temps dure le protocole d'escalade de dose ?"
    answer: "En général 16 à 20 semaines selon la molécule. Le sémaglutide (Ozempic, Wegovy) augmente par paliers de 4 semaines. Le tirzépatide (Mounjaro) suit un schéma similaire. Chaque palier doit être toléré avant de passer au suivant."
mainKeyword: "suivi GLP-1 perte de poids"
secondaryKeywords: ["suivi traitement GLP-1", "journal bord GLP-1", "tracker poids GLP-1", "courbe perte poids ozempic", "consultation suivi GLP-1"]
...
| Paramètre | Objectif | Pourquoi |
|---|---|---|
| Glycémie à jeun | < 1,10 g/L | Contrôle glycémique |
| HbA1c (si diabète) | < 7 % en général | Équilibre sur 3 mois |
| Créatinine + DFG | Fonction rénale stable | Surveillance rénale |
| ALAT / ASAT | < 3× la normale | Surveillance hépatique |
| Cholestérol total, LDL, HDL | Selon les cibles personnalisées | Bénéfice cardiovasculaire |
| Triglycérides | < 1,50 g/L | Risque métabolique |

### Mesures semestrielles

Tous les 6 mois, ajoutez à votre bilan :

- **Vitamine B12** : les GLP-1 peuvent réduire l'absorption intestinale, surtout en cas de prise concomitante de metformine. Consultez notre article sur les [carences nutritionnelles sous GLP-1](/collections/regime-glp1/glp1-carences-nutritionnelles-bilan-sanguin-supplementation/) pour tout savoir.
...
1. **Alimentation** : pas besoin de compter chaque calorie, mais notez les repas principaux et les écarts. Le [régime méditerranéen](/collections/regime-glp1/regime-mediterraneen-glp1/) reste le modèle alimentaire le mieux étudié en association avec les GLP-1.
2. **Hydratation** : nombre de verres d'eau ou de litres (objectif : 1,5 à 2 L par jour)
3. **Activité physique** : type, durée, intensité ressentie. L'[exercice sous GLP-1](/collections/regime-glp1/glp1-sport-exercice-musculation-guide/) est essentiel pour préserver la masse musculaire.
...
| Semaine | Poids (kg) | Variation | Tour taille (cm) | Dose actuelle | Effets secondaires | Notes |
|---|---|---|---|---|---|---|
| S1 | 98,4 | — | 108 | 0,25 mg | Nausées légères J1-J2 | Début traitement |
| S2 | 97,8 | −0,6 | — | 0,25 mg | Nausées J1 | Mieux toléré |
| S3 | 97,1 | −0,7 | — | 0,25 mg | RAS | Bonne semaine |
| S4 | 96,5 | −0,6 | 106 | 0,25 mg → 0,5 mg | — | Passage palier |
...
- **Recomposition corporelle** : si vous faites de la musculation, vous pouvez perdre du gras tout en gagnant du muscle. Le poids stagne, mais votre silhouette change. C'est pourquoi le [maintien de la masse musculaire](/collections/regime-glp1/glp1-fonte-musculaire-preserver-muscles/) est si important.
...
1. **L'alimentation** : les calories liquides (jus, smoothies, alcool) et le grignotage inconscient sont les premières causes de plateau. Le [suivi des portions](/collections/regime-glp1/glp1-portion-alimentaire/) peut révéler des apports sous-estimés.
...
|---|---|---|
| S1 à S4 | 0,25 mg | Phase d'initiation, tolérance |
| S5 à S8 | 0,5 mg | Premier palier thérapeutique |
| S9 à S12 | 1 mg | Dose efficace standard (Ozempic) |
| S13 à S16 | 1,7 mg | Escalade Wegovy uniquement |
| S17+ | 2,4 mg | Dose maximale Wegovy |

### Tirzépatide (Mounjaro)

| Semaines | Dose | Objectif |
|---|---|---|
| S1 à S4 | 2,5 mg | Phase d'initiation |
| S5 à S8 | 5 mg | Premier palier efficace |
| S9 à S12 | 7,5 mg | Ajustement progressif |
| S13 à S16 | 10 mg | Dose intermédiaire |
| S17 à S20 | 12,5 mg | Ajustement avancé |
| S21+ | 15 mg | Dose maximale |
...
- **Explorer les alternatives non GLP-1** : orlistat, naltrexone-bupropion ou approche chirurgicale dans les cas d'obésité sévère. Notre article sur les [alternatives aux GLP-1](/collections/alternatives-glp1/) détaille ces options.
...
- **Diminution de l'appétit** : c'est l'effet recherché, mais veillez à maintenir un apport [protéique suffisant](/collections/regime-glp1/glp1-proteines/) (1,2 à 1,5 g/kg/jour) pour préserver vos muscles.
...
- **Constipation** : augmentez les fibres progressivement (légumes, légumineuses, psyllium) et l'eau. La [chrono-nutrition](/collections/regime-glp1/regime-chrono-nutrition-glp1/) peut aider à structurer les repas.
...
- **La perte de masse musculaire** : si vous perdez du poids rapidement sans exercice de résistance, la [fonte musculaire](/collections/regime-glp1/glp1-fonte-musculaire-preserver-muscles/) peut devenir significative
- **Les carences** : un bilan vitaminique semestriel est indispensable, surtout pour la [B12, la vitamine D et le fer](/collections/regime-glp1/glp1-carences-nutritionnelles-bilan-sanguin-supplementation/)
- **L'état psychologique** : certains patients ressentent une forme de deuil alimentaire ou d'anxiété face au changement corporel. Un [accompagnement psychologique](/collections/regime-glp1/glp1-accompagnement-psychologique-comportement-alimentaire/) peut être bénéfique.
...
| Mois | Consultation | Bilan sanguin | Actions |
|---|---|---|---|
| M0 | Consultation initiale | Bilan complet (glycémie, rein, foie, lipides, thyroïde, vitamines) | Prescription, objectifs, éducation injection |
| M1 | Suivi rapproché (ou téléconsultation) | — | Tolérance, effets secondaires, ajustement dose |
| M3 | Consultation + mesures | Bilan trimestriel | Évaluation perte de poids, escalade dose |
| M6 | Consultation + mesures | Bilan trimestriel + vitamines | Point d'étape, objectifs revus |
...
- Maintenez les habitudes alimentaires acquises pendant le traitement : le [régime méditerranéen](/collections/regime-glp1/regime-mediterraneen-glp1/), le contrôle des [portions](/collections/regime-glp1/glp1-portion-alimentaire/) et l'hydratation
...
3. **Négliger l'apport protéique** : manger moins ne suffit pas. Sans protéines suffisantes, vous perdez du muscle, pas seulement du gras. Visez 1,2 à 1,5 g de [protéines](/collections/regime-glp1/glp1-proteines/) par kg de poids corporel par jour.
