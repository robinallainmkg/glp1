...
mainKeyword: "GLP-1 carences nutritionnelles bilan sanguin supplémentation guide"
secondaryKeywords: ["carence fer ozempic", "vitamines sous wegovy", "bilan biologique glp1", "supplémentation mounjaro", "anémie glp1 traitement", "déficit vitamine B1 semaglutide"]
schema: "Article"
published: true
priority: 2
...
En 2024, l'ANSM a identifié un signal de pharmacovigilance concernant des carences sévères chez certains patients sous [Ozempic](/collections/traitements-glp1/guide-complet-ozempic/), [Wegovy](/collections/traitements-glp1/guide-complet-wegovy/) et [Mounjaro](/collections/traitements-glp1/guide-complet-mounjaro/). Ce guide vous explique quelles analyses demander, comment interpréter vos résultats et comment adapter votre alimentation ou votre supplémentation.
...
- **Apports protéiques suffisants** : viser 1,2 à 1,6 g de protéines par kg de poids corporel par jour (soit 80-100 g/j pour une personne de 70 kg). Consultez notre guide sur les [protéines sous GLP-1](/collections/regime-glp1/glp1-proteines/)
