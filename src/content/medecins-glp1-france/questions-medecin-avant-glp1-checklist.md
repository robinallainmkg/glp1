---
title: "Questions à Poser à son Médecin Avant un GLP-1 : Checklist Complète"
description: "Checklist complète des questions à poser lors de votre première consultation pour un traitement GLP-1 : éligibilité, choix du traitement, effets secondaires, coût, suivi et durée."
pubDate: 2026-05-28
date: "2026-05-28"
...
thumbnailAlt: "Questions à poser médecin avant traitement GLP-1 checklist"
featured: true
published: true
priority: 2
schema: "Article"
faqSchema:
  - question: "Combien de temps dure une première consultation pour un GLP-1 ?"
    answer: "Prévoyez 30 à 45 minutes pour une première consultation complète. Le médecin doit évaluer votre historique, réaliser un examen clinique, discuter des options et vous expliquer le protocole. N'hésitez pas à demander un créneau long lors de la prise de rendez-vous."
  ...
  - question: "Puis-je poser mes questions par écrit au médecin avant la consultation ?"
    answer: "Absolument. Apportez votre liste de questions imprimée ou sur votre téléphone. De nombreux médecins apprécient les patients préparés : cela rend la consultation plus efficace et montre votre engagement dans la démarche."
mainKeyword: "questions médecin GLP-1"
secondaryKeywords: ["questions médecin ozempic", "première consultation GLP-1", "que demander médecin wegovy", "rendez-vous médecin obésité", "checklist consultation GLP-1"]
...
Si votre consultation est la première dans un [parcours de prescription GLP-1](/collections/medecins-glp1-france/comment-commencer-traitement-glp1-france/), ce guide vous sera particulièrement utile pour structurer l'échange.
...
Ce n'est pas une question indiscrète. Un médecin qui a suivi de nombreux patients sous GLP-1 anticipe mieux les effets secondaires et ajuste les doses plus finement. S'il débute avec ces traitements, il peut vous orienter vers un collègue plus expérimenté ou un [endocrinologue spécialisé](/collections/medecins-glp1-france/endocrinologue-pour-maigrir/).
...
- **Vous engagiez dans le suivi** : un traitement GLP-1 n'est pas une solution magique. Il fonctionne mieux associé à une [alimentation équilibrée](/collections/regime-glp1/regime-mediterraneen-glp1/) et une activité physique régulière
...
1. **Réaliser les examens prescrits** dans la semaine si possible — cela évite de retarder le début du traitement
2. **Obtenir l'ordonnance** et vérifier la disponibilité du médicament dans votre pharmacie. Les tensions d'approvisionnement existent ponctuellement, anticipez de quelques jours.
3. **Prendre le prochain rendez-vous** de suivi (1 mois après le début du traitement, en général)
4. **Contacter votre mutuelle** pour connaître les modalités de prise en charge éventuelles
5. **Commencer un journal de bord** : notez votre poids, vos repas, vos effets secondaires et votre humeur dès le premier jour de traitement
6. **Informer votre entourage** si vous le souhaitez — le soutien social est un facteur d'observance documenté

Si vous souhaitez être accompagné par des médecins spécialisés en téléconsultation, vous pouvez consulter notre guide sur la [prescription GLP-1 en télémédecine](/collections/medecins-glp1-france/prescription-glp1-telemedecine-en-ligne-france/) pour connaître les options disponibles.
