...
export default defineConfig({
  ...
  integrations: [
    sitemap({
      ...
      priority: 0.7,
      lastmod: new Date(),
      filter: (page) => !page.includes('/admin/') && !page.includes('/test-admin/') && !page.includes('/test-supabase/') && !page.includes('/test-affiliation-multi/') && !page.includes('/admin-dashboard/') && !page.includes('/admin-stats/') && !page.includes('/demo-affiliate-sidebar/') && !page.includes('/temoignages-glp1') && !page.includes('/guide-beaute-perte-de-poids-glp1') && !page.includes('/produits-recommandes') && !page.includes('/temoignage-') && !page.includes('/diagnostic-') && !page.includes('/test-affiliation/'),
      customPages: [
