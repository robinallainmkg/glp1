# File d'attente GSC — soumission manuelle (inspection d'URL)

Fichier cumulatif maintenu par la routine (regle 3bis, CLAUDE.md). Robin coche quand c'est soumis.
La routine AJOUTE ici a chaque publication — elle ne relance jamais dans le chat.
...
_(deplacer ici une fois cochees, avec la date)_
