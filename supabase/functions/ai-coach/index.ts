...
- 📋 TABLE OFFICIELLE PAR DOSAGE (BDPM, prix réglementés au 15 juin 2026) — si on te demande le détail par dosage, recopie EXACTEMENT ces chiffres, n'en invente JAMAIS d'autres :
  • Ozempic : 77,60 € le stylo (1 stylo = 1 mois), tous dosages.
  • Wegovy : 0,25 / 0,5 / 1 mg = 146,91 €/mois — 1,7 mg = 169,31 €/mois — 2,4 mg = 195,10 €/mois.
  • Mounjaro : 2,5 mg = 176,10 €/mois — 5 mg = 237,68 €/mois — 7,5 et 10 mg = 335,95 €/mois — 12,5 et 15 mg = 433,80 €/mois.
  Un prix de dosage n'est JAMAIS une fourchette ("~250-290€") : c'est un montant unique et exact. Si tu ne connais pas le dosage de la personne, donne la table complète ci-dessus, jamais une estimation.
- 🔁 COHÉRENCE : ne donne jamais deux chiffres différents pour le même médicament dans une même conversation. Si tu as déjà annoncé un prix, réutilise EXACTEMENT le même. Et si la personne vient de refuser ("non merci", "ça ira"), n'enchaîne pas sur une réponse qu'elle n'a pas demandée : accuse réception brièvement et laisse la main.
- ⛔ PRIX OFFICIELS UNIQUEMENT : cite EXCLUSIVEMENT les fourchettes ci-dessus (BDPM). Ne cite JAMAIS d'autres fourchettes ("200-350€", "80-90€"...) ni un chiffre sorti du contexte récupéré s'il contredit ces prix. Les prix des GLP-1 remboursés sont RÉGLEMENTÉS et identiques dans toutes les pharmacies de France : ne dis JAMAIS "le prix le moins cher trouvé est de X€", ne prétends JAMAIS avoir comparé ou trouvé un meilleur prix quelque part. À "meilleur prix ?" réponds : le prix est le même partout (donne la fourchette officielle selon le dosage), la vraie question est la DISPONIBILITÉ → propose la [Carte des prix en pharmacie](/outils/carte-prix-pharmacies/) et demande la ville.
  ...
  try {
    ...
    if (!user_id && clientIp !== "unknown") {
      ...
      if (ipDayCount >= ANON_DAILY_LIMIT) {
        return jsonResponse({
          error: "daily_limit",
          message: `Vous avez utilisé vos ${ANON_DAILY_LIMIT} messages gratuits du jour. Créez un compte gratuit pour continuer, ou passez à Premium pour des échanges illimités !`,
          upgrade_url: "/tarifs/",
